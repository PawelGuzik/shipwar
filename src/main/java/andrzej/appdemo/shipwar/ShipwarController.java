...
/**
 *
 *  This class is responsible for managing the responses to requests
 *  generated by the user who plays ships.
 *
 * @author Paweł Guzik
 */
@Controller
public class ShipwarController {
    ...
    /**
     * Is the object responsible for communication with the database
     */
    @Autowired
     ...
     * is set to 3 that means users are playing game now.
     *
     * @param model the model supply attributes used for rendering views.
    ...
    /**
     * Clears data about players of the completed game, and provides information whether the player won or lost
     * to the page informing about the end of this game.
     *
     * @param model the model supply attributes used for rendering views.
     * @param user user who lost or won the game.
     * @param s relevant information about winning or losing, sent to the user.
     */
    ...
    /**
     * Informs that the user has been correctly logged out.
     *
     * @param model the model supply attributes used for rendering views.
    ...
    /**
     * This method maps the positions of the ships from the 'user' and 'enemy' objects to the model
     * which is sent to the page where the game status is displayed
     * @param model the model supply attributes used for rendering views.
     * @param user the user whose ship's positions will be transcribed to the game page.
     * @param enemy the user whose ship's positions will be transcribed to the game page on the opponent's side.
     */
